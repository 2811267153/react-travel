...
import {Typography, Carousel, Image, Rate} from "antd"
...
export const ProductIntro: React.FC<ProductIntro> = ({
                                                         title,
                                                         rating,
                                                         touristRoutePictures,
                                                         coupons,
    ...
    return (
        <div className="intro-container">
            ...
            <div className="intro-detail-content">
                <Typography.Text style={{marginLeft: 20}}>价格: <span>{price}</span></Typography.Text>
            </div>
            <div className="intro-detail-content">
                <Typography.Text style={{marginLeft: 20}}>评分: <span>{rating}</span></Typography.Text>
            </div>
            <Carousel autoplay slidesToShow={3} style={{marginTop: 10, marginBottom: 10}}>
                {touristRoutePictures.map((item, index: number) => <Image key={index} fallback={defaultIcon} height={150} src={touristRoutePictures[index].url}/>)}
            </Carousel>
